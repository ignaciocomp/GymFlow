...
public class GymFlowDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Planes, Clases, Cuotas y Empleados, mas Unidades Lectura y Dashboard Lectura (RF-18).
        // SIN Auditoria (exclusiva del Admin).
        ...
        var permisosDueno = permisoIds
            .Where(kvp => modulosOperativosDueno.Contains(kvp.Key.Item1)
                ...
                || (kvp.Key.Item1 == Modulo.Dashboard && kvp.Key.Item2 == Operacion.Lectura))
